...
class MethodCallHandlerImplNew(
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            "switchCameraById" -> {
                val cameraId = call.argument<String>("cameraName")
                if (cameraId == null) {
                    result.error("invalidArgument", "cameraName required", null)
                } else {
                    val view = getCameraView()
                    if (view == null) {
                        result.success(null)
                    } else {
                        view.switchCameraById(cameraId, result)
                    }
                }
            }
            ...
            "flipCamera" -> {
                val view = getCameraView()
                if (view == null) {
                    result.error("flipCameraFailed", "Camera not ready", null)
                } else {
                    view.flipCamera(result)
                }
            }
            ...
            "setExposureCompensation" -> {
                ...
                if (view == null) {
                    ...
                    view.setExposureCompensation(ev, result)
                }
            }
            ...
            "setFocusLock" -> {
                ...
                if (view == null) {
                    ...
                    view.setFocusLock(locked, result)
                }
            }
            ...
            "updateStreamOverlay" -> {
                ...
                val view = getCameraView()
                if (view == null || png == null) {
                    result.success(null)
                } else {
                    view.updateStreamOverlay(png, width, height, result)
                }
            }
            ...
            "clearStreamOverlay" -> {
                ...
                if (view == null) {
                    ...
                    view.clearStreamOverlay(result)
                }
            }
            ...
            "recoverRtmpReconnectState" -> {
                ...
                if (view == null) {
                    ...
                    view.recoverRtmpReconnectState(result)
                }
            }
