...
enum AdminPermission {
  ...
  String get label => switch (this) {
        ...
        AdminPermission.canManageGrounds => 'Manage grounds',
        ...
        AdminPermission.canViewSystemHealth => 'View system health',
...
abstract final class DefaultAdminRolePermissions {
  ...
  static Set<AdminPermission> forRole(AdminRole role) => switch (role) {
        ...
        AdminRole.admin => {
            ...
            AdminPermission.canManageGrounds,
            AdminPermission.canSendNotifications,
            AdminPermission.canManageAds,
            AdminPermission.canModerateCommunity,
            AdminPermission.canManageBroadcast,
            AdminPermission.canViewAnalytics,
            AdminPermission.canViewSystemHealth,
            AdminPermission.canManageSupport,
            AdminPermission.canManageAiOps,
